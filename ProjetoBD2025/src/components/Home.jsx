          ...
          <Col key={movie.id} md={3}>
            <Card className="movie-card">
              ...
              <Card.Body className="d-flex flex-column">
                ...
                <Card.Text>
                  <small className="text-muted">Lançamento: {movie.dataLancamento || 'N/A'}</small>
                </Card.Text>
                <div className="mt-auto">
                  <Button variant="primary" onClick={() => handleEditar(movie)}>Editar</Button>
                  <Button style={{marginLeft: '10px'}} variant="primary" onClick={() => handleEditar(movie)}>Adicionar</Button>
